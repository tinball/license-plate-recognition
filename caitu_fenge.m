...
k=0;
while(~((baisebili>=0.12)&&(baisebili<=0.5)&&(changkuanbi>=0.20)&&(changkuanbi<=0.6)))%改善倾斜
    if  (k==0)%第一次进来
...
%==============X 方向===============================
        X_threshhigh=(PY2-PY1)/11;%这个数值很重要。决定了提取的彩图的质量,适当提高可抗干扰，但是小图会造成剪裁太多
...
%========================================================
Y_firrectify=fix((PY2-PY1)/5);%取整，适当扩大这个值可以正确旋转
